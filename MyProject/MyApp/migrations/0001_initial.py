    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(choices=[('Mumbai', 'Mumbai'), ('Delhi', 'Delhi'), ('Pune', 'Pune'), ('Nasik', 'Nasik'), ('Auranabad', 'Auranabad'), ('Bangluru', 'Bangluru'), ('Bangluru', 'Bangluru'), ('Basti', 'Basti'), ('Lonavala', 'Lonavala')], max_length=100)),
